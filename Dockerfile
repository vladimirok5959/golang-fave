...
ADD https://github.com/vladimirok5959/golang-fave/releases/download/v1.4.6/fave.linux-amd64.tar.gz /app/fave.linux-amd64.tar.gz
ADD https://github.com/vladimirok5959/golang-fave/releases/download/v1.4.6/localhost.tar.gz /app/hosts/localhost.tar.gz
