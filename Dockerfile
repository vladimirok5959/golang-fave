...
ADD https://github.com/vladimirok5959/golang-fave/releases/download/v1.1.7/fave.linux-amd64.tar.gz /app/fave.linux-amd64.tar.gz
ADD https://github.com/vladimirok5959/golang-fave/releases/download/v1.1.7/localhost.tar.gz /app/hosts/localhost.tar.gz
