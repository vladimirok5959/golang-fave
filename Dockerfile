...
ADD https://github.com/vladimirok5959/golang-fave/releases/download/v1.2.0/fave.linux-amd64.tar.gz /app/fave.linux-amd64.tar.gz
ADD https://github.com/vladimirok5959/golang-fave/releases/download/v1.2.0/localhost.tar.gz /app/hosts/localhost.tar.gz
